...
Mandatory Arguments & Flags:
  BANKS_DIR   Directory containing bank .json files (e.g., $HOME/.config/omp/hindsight-bankconfig)
...
Examples:
  ./update-memory-banks.sh $HOME/.config/omp/hindsight-bankconfig http://localhost:8888 --yes
  ./update-memory-banks.sh $HOME/.config/omp/hindsight-bankconfig http://localhost:8888 --yes --prune
EOF
}
