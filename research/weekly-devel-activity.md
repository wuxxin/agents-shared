...
<!-- START_BD_ZEROCLAW -->
* **Status**: Highly Active (Total: 190 commits [190 H / 0 B], 1 tag/release in the last week). Lines added/deleted: +51.1k/-223.7k (Human), +0/-0 (Bot). **2 commits since installed 0.8.2.r43.g97f8782ed-1 (ref=97f8782ed).**
* **Contributors (according to last 7 days commits)** (Total: 32 Humans, 0 Bots):
  - **Top Humans**:
    - `Dan Gilles <dfgilles@uchicago.edu>` (Human): 47 commits, +11.3k/-1.5k lines
    - `Shane Engelman <contact@shane.gg>` (Human): 30 commits, +10.6k/-218.3k lines
    - `Marc Collins <marc@nnet.tech>` (Human): 25 commits, +15.2k/-2.8k lines
    - `Jason Perlow <jperlow@gmail.com>` (Human): 12 commits, +1.7k/-338 lines
    - `Alix-007 <li.long15@xydigit.com>` (Human): 9 commits, +503/-2 lines
    - `wangmiao0668000666 <wang.miao86@xydigit.com>` (Human): 9 commits, +2.8k/-131 lines
    - `JordanTheJet <morepencils@gmail.com>` (Human): 7 commits, +656/-127 lines
...
<!-- START_BD_IRONCLAW -->
* **Status**: Highly Active (Total: 96 commits [95 H / 1 B], 1 tag/release in the last week). Lines added/deleted: +114.4k/-34.0k (Human), +14/-3 (Bot). **54 commits since installed ironclaw_skill_learning.v0.1.0.r21.g4f28feb-1 (ref=4f28feb).**
* **Contributors (according to last 7 days commits)** (Total: 11 Humans, 1 Bots):
  - **Top Humans**:
    - `firat.sertgoz <firat.sertgoz@near.ai>` (Human): 32 commits, +25.0k/-6.8k lines
    - `Henry Park <henrypark133@gmail.com>` (Human): 17 commits, +32.9k/-7.3k lines
    ...
    - `Illia Polosukhin <ilblackdragon@gmail.com>` (Human): 7 commits, +7.4k/-933 lines
    ...
    - `Josh Ford <thisisjoshford@gmail.com>` (Human): 1 commits, +92/-2 lines
  - **Top Bots**:
    - `dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com>` (Bot): 1 commits, +14/-3 lines
<!-- END_BD_IRONCLAW -->
<!-- START_RF_IRONCLAW -->
* **Recent Focus**:
...
* **Contributors (according to last 7 days commits)** (Total: 170 Humans, 0 Bots):
  - **Top Humans**:
    ...
    - `Ben Barclay <ben@nousresearch.com>` (Human): 16 commits, +3.4k/-138 lines
    - `liuhao1024 <sunsky.lau@gmail.com>` (Human): 16 commits, +1.5k/-93 lines
    - `helix4u <4317663+helix4u@users.noreply.github.com>` (Human): 10 commits, +926/-35 lines
<!-- END_BD_HERMES_AGENT -->
...
<!-- START_BD_NANOBOT -->
* **Status**: Highly Active (Total: 150 commits [147 H / 3 B], 1 tag/release in the last week). Lines added/deleted: +14.7k/-4.8k (Human), +116/-3 (Bot).
* **Contributors (according to last 7 days commits)** (Total: 20 Humans, 1 Bots):
  - **Top Humans**:
    ...
    - `Xubin Ren <52506698+Re-bin@users.noreply.github.com>` (Human): 36 commits, +6.5k/-725 lines
    ...
    - `michaelxer <michaelxer@users.noreply.github.com>` (Human): 6 commits, +156/-37 lines
    - `Ilya Gusev <phoenixilya@gmail.com>` (Human): 4 commits, +123/-63 lines
  ...
  - **Top Bots**:
    - `NanoBot <nanobot@local>` (Bot): 3 commits, +116/-3 lines
<!-- END_BD_NANOBOT -->
<!-- START_RF_NANOBOT -->
* **Recent Focus**:
...
<!-- START_BD_LIBREFANG -->
* **Status**: Highly Active (Total: 66 commits [55 H / 11 B], 4 tags/releases in the last week). Lines added/deleted: +15.8k/-8.0k (Human), +385/-379 (Bot).
* **Contributors (according to last 7 days commits)** (Total: 5 Humans, 2 Bots):
  - **Top Humans**:
    - `Evan <suzukaze.haduki@gmail.com>` (Human): 39 commits, +5.0k/-5.6k lines
  ...
  - **Top Bots**:
    - `github-actions[bot] <41898282+github-actions[bot]@users.noreply.github.com>` (Bot): 6 commits, +122/-106 lines
...
* **Recent Focus**:
  ...
  - `daed0e67` fix(kernel): guard gc_sweep running_tasks removal with task_id (TOCTOU) (#6317)
<!-- END_RF_LIBREFANG -->
---
