...
## Complete Application Configuration Example (`opencode`)

See [opencode.env](../sandbox-templates/opencode/opencode.env) and [README.md](../sandbox-templates/opencode/README.md)
